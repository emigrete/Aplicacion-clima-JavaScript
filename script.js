...
const API_KEY = "302c6129f6687c476d94986497e668da";
...
document.getElementById("searchButton").addEventListener("click", () => {
  ...
  if (city) {
    ...
    alert("Ingrese una ciudad válida"); //Alerta para ingresar una ciudad valida
  }
});
...
function showWeatherData(data) {
  ...
  icoInfo.src = `https://openweathermap.org/img/wn/${icon}@2x.png`; // verificar la documentacion como una imagen
